...
#
ALERTMANAGER := $(GOBIN)/alertmanager-v0.25.0
$(ALERTMANAGER): $(BINGO_DIR)/alertmanager.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/alertmanager-v0.25.0"
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=alertmanager.mod -o=$(GOBIN)/alertmanager-v0.25.0 "github.com/prometheus/alertmanager/cmd/alertmanager"
...
MINIO := $(GOBIN)/minio-v0.0.0-20230112020616-7bc95c47a322
$(MINIO): $(BINGO_DIR)/minio.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/minio-v0.0.0-20230112020616-7bc95c47a322"
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=minio.mod -o=$(GOBIN)/minio-v0.0.0-20230112020616-7bc95c47a322 "github.com/minio/minio"
...
$(PROMETHEUS): $(BINGO_DIR)/prometheus.mod
	...
	@cd $(BINGO_DIR) && GOWORK=off $(GO) build -mod=mod -modfile=prometheus.mod -o=$(GOBIN)/prometheus-v0.38.0 "github.com/prometheus/prometheus/cmd/prometheus"
