...
replace (
	...
	// Force a go-control-plane version that no longer vendors the envoy/* API packages
	// (split into github.com/envoyproxy/go-control-plane/envoy), to avoid an ambiguous
	// import conflict with the newer envoy API packages required transitively by the
	// CVE-2026-42151 prometheus fork below.
