...
replace (
	...
	// Pin prometheus/common to the version thanos was built against, to avoid
	// breaking API changes in v0.54+ (unexported secret interface). The CVE fix
	// only uses config.Secret which exists in all versions.
	github.com/prometheus/common => github.com/prometheus/common v0.49.1-0.20240306132007-4199f18c3e92

	// CVE-2026-42151: Prometheus Azure AD remote write OAuth client_secret exposed via config API.
	// Patched fork with fix cherry-picked from upstream prometheus/prometheus#18587.
	github.com/prometheus/prometheus => github.com/stolostron/prometheus v1.8.2-0.20260807141503-82aa3b09cb50

	github.com/vimeo/galaxycache => github.com/thanos-community/galaxycache v0.0.0-20211122094458-3a32041a1f1e

	// Pin otlptracegrpc to v1.24.0 to remain compatible with the grpc v1.57.2
	// replace below (v1.27.0 uses grpc.NewClient which was added in grpc v1.63).
